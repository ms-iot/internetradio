...
extern PCSTR c_InternetRadioIntrospectionXml;

ref class InternetRadioProducer;

public interface class IInternetRadioProducer
{
    event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class InternetRadioProducer sealed : [Windows::Foundation::Metadata::Default] IInternetRadioProducer
{
public:
    InternetRadioProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~InternetRadioProducer();

    // The implementation of IInternetRadioService that will handle method calls and property requests.
    property IInternetRadioService^ Service
    {
        IInternetRadioService^ get() { return m_serviceInterface; }
        void set(IInternetRadioService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<InternetRadioProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
...
private:
    ...
    IInternetRadioService^ m_serviceInterface;
